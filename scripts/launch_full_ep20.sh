#!/bin/bash
# Launch 12 conditions for full fine-tuning with 20 training epochs across 8 GPUs.
# 3 models × 4 contamination levels = 12 jobs
#
# Usage:
#   cd ~/final_proj && nohup bash scripts/launch_full_ep20.sh > outputs/gpu_full_run/launch_full_ep20.log 2>&1 &
